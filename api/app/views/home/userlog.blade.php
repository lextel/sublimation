    ...
    <div role="main" class="ui-content addressWrap">
        ...
        <div  data-role="tabs" id="tabs">
            ...
            <div id="one" class="item">
                <table data-role="table" id="table-custom-1" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe ui-responsive" data-column-btn-theme="b" data-column-popup-theme="a" data-column-btn-text="显示列...">
                    <thead>
                    <tr class="ui-bar-d">
